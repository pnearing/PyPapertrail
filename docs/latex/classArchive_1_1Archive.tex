...
\begin{center}
\leavevmode
\includegraphics[width=173pt]{classArchive_1_1Archive__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=173pt]{classArchive_1_1Archive__coll__graph}
\end{center}
\end{figure}
...
\item 
src/\+Py\+Papertrail/Archive.\+py\end{DoxyCompactItemize}
